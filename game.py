...
class GameUI:
    ...
    def __init__(self, player):
        ...
        self._board_img = pygame.image.load('board.png')
        self._board_img_numbers = pygame.image.load("board_numbers.png")
    ...
    def draw_player_won(self, player):
        ...
        text = player.get_name() + " won! Restart (YES | NO)?"
    ...
    def draw_board(self, player = None, row = -1, column = -1):
        ...
        if player is not None:
            ...
            (self.OFFSET + self.CHIP_RADIUS + self.CHIP_OFFSET * column + self.CHIP_SIZE * column, self.BOARD_HEIGHT - self.CHIP_SIZE * row - self.CHIP_OFFSET * row), self.CHIP_RADIUS)
